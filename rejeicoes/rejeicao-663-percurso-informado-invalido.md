...
Dentro do **formulário** do [MDF-e](/movimentos/mdf-e), na sessão de **UF de percurso**. após clicar em (<span class="mdi mdi-pencil"></span>). É necessário informar **corretamente** os **estados** e a **ordem** dos mesmos.
