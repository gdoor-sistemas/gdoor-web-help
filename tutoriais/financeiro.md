...
O módulo financeiro no GDOOR WEB consiste basicamente em um cadastro de contas, receitas e despesas. Com esses registros você consegue gerenciar o dinheiro que entra e sai das contas da empresa, mantendo um histórico das receitas que são geradas automaticamente após a emissão de [NF-e](/tutoriais/como-emitir-uma-nfe) ou [NFC-e](/movimentos/nfc-e) ou podem ser cadastradas manualmente. Também, as contas a pagar podem ser geradas após a confirmação de uma nota de compra, bem como podem ser cadastradas individualmente.
...
Para mais detalhes sobre cada seção do módulo financeiro, acesse o artigo específico de cada uma:
