...
> Os dados de **IBC/CBS** podem ser informados **manualmente** na nota fiscal ou de **forma automática** através das [regras de tributação](#alterações-nas-regras-de-tributação).
{.is-info}
