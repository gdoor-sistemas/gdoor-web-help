...
Ao acessar o aplicativo **ZPOS** na maquininha, será apresentado a mensagem **"Conectado, aguardando vendas"**, junto com o **número de série** para registro da maquininha, se necessário.
