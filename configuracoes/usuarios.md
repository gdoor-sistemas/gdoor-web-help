...
No canto **direito inferior** da [lista de usuários](/configuracoes/usuarios#lista-de-usuarios) há o botão de adição (<em class="mdi mdi-plus"></em>) para "**cadastrar novo usuário**".
