...
- Adequações NT 1.36, referente a nota de crédito tipo 6 "Retorno por recusa parcial na entrega".
- Adequações NT 1.40, refetente a NF-e de devolução e débito tipo 4, campos de tributação para ALC/ZFM e devolução de tributos. 
- Implementados campos para Compra Governamental o módulo NF-e.
- Adequaçõe a Nota Técnica Nº 007, referente ao Grupo de informações dos tributos PIS/COFINS na NFS-e.
...
- DEP29572 - Ajustada ordenação por cliente no relatório de contas a receber.
...
## Ajustes
- Ajustada emissão do CT-e com CST 410.
...
## Ajustes
- Ajustada de função de adicionar NFe em MDFe com carregamento posterior.

# 22/04/2026
b3.10.449 {.versions}

## Ajustes
- Ajustada impressão da NFS-e para trazer informações complementares da nota.
...
## Ajustes
- Ajustado travamento ao cancelar operação no TEF.
...
- Adicionados os campos percentual total de tributos federais, estaduais, municipais e do simples nacional, assim como indicador total de tributação na NFSe.
