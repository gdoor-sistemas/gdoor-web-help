...
- Ajustada criação do ECONF via NF-e.
...
## Ajustes
- Ajustado carregamento das configurações e banco de dados ao acessar a base no PDV Híbrido.
...
## Ajustes
- Ajustada ordenação por cliente no relatório de contas a receber, apresentando o código após o nome e a ordenação alfabética.
