...
Para adicionar serviços na pré-venda, você precisa habilitar o uso de serviços nas [configurações](https://help.gdoorweb.com.br/pt-br/configuracoes/geral#servi%C3%A7os) e depois [cadastrar os serviços](/cadastros/servicos).
