...
> É importante notar que, devido ao sistema ser uma página da web, há limitações normais quanto ao uso, como por exemplo, não há como enviar a impressão do cupom da NFC-e diretamente para a impressora, é necessário usar o diálogo de impressão do navegador.
