...
Selecionando a oção **Glink** mostrada na tela anterior, será apresentada a listagem de todos os equipamentos (celular ou tablet) que foram habilitados para a empresa utilizar na emissão de pedidos.
